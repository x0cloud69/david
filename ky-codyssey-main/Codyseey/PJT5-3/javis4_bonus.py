...
def search_csv_keyword(file_path, kwyword):
...
if __name__ == "__main__":
    ...
    keyword = input("검색할 Keyword를 입력 하세요 :")
    selected_file = selected_file.replace('.wav','.csv')
    search_csv_keyword(selected_file,keyword)
